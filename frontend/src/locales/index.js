export const messages = {
  en: {
    ...
    settings: {
      ...
      showOnlyDesktopTerminal: 'Show Only Desktop Terminal',
      showTtydAndDesktop: 'Show ttyd & Desktop Terminal',
      ...
      localTerminalShell: 'Desktop Shell',
      localTerminalShellHelp: 'Leave empty to auto-detect the best shell for your platform.',
      localTerminalCwd: 'Desktop Working Directory',
      localTerminalCwdHelp: 'Defaults to your MoFA directory. ~ resolves to your home directory.',
      useSystemDefault: 'System Default',
      useMofaDir: 'Use MoFA Dir',
    ...
    electronTerminal: {
      ...
      themeDark: 'Dark',
      themeLight: 'Light',
      unavailable: 'Desktop terminal is only available inside the Electron app.',
      noSessions: 'Create a tab to start a local shell session.',
      startFirst: 'Open Terminal',
      connecting: 'Connecting to shell...',
      tabTitlePrefix: 'Shell',
      customLaunch: 'Custom Session',
      tabTitle: 'Tab Title',
      shellCommand: 'Shell Command',
      shellHelp: 'Leave empty to use the default shell from settings or system profile.',
      workingDirectory: 'Working Directory',
      cwdHelp: 'Absolute paths are recommended. ~ resolves to your home directory.',
      useDefault: 'Default',
      useMofaDir: 'Use MoFA Dir',
      launch: 'Launch',
      sessionExited: 'Exited',
      sessionExitedHelp: 'Session ended. Launch a new tab or restart from the menu.',
      shellMissing: 'Shell command is required.'
    },
    terminal: {
  ...
  zh: {
    ...
    settings: {
      ...
      showOnlyDesktopTerminal: '只显示桌面终端',
      showTtydAndDesktop: '显示 ttyd 与桌面终端',
      terminalDisplayModeHelp: '选择要在侧边栏中显示哪个终端。需要刷新页面才能生效。',
      ttydPort: 'ttyd端口',
      ttydPortHelp: 'ttyd服务将在此端口上运行。默认是7681。需要重启服务才能生效。',
      localTerminalShell: '桌面终端 Shell',
      localTerminalShellHelp: '留空将自动探测适合当前系统的 Shell。',
      localTerminalCwd: '桌面终端工作目录',
      localTerminalCwdHelp: '默认使用 MoFA 目录。~ 会解析为您的主目录。',
      useSystemDefault: '使用系统默认',
      useMofaDir: '使用 MoFA 目录',
    ...
    electronTerminal: {
      ...
      themeDark: '暗色',
      themeLight: '亮色',
      unavailable: '桌面终端仅在 Electron 客户端中可用。',
      noSessions: '点击上方按钮创建本地 Shell 会话。',
      startFirst: '打开终端',
      connecting: '正在连接终端...',
      tabTitlePrefix: '终端',
      customLaunch: '自定义会话',
      ...
      shellHelp: '留空将使用设置或系统默认的 Shell。',
      workingDirectory: '工作目录',
      cwdHelp: '推荐填写绝对路径。~ 会解析为您的主目录。',
      useDefault: '恢复默认',
      useMofaDir: '使用 MoFA 目录',
      launch: '启动',
      sessionExited: '已退出',
      sessionExitedHelp: '进程已结束，可重新启动或新建终端。',
      shellMissing: '请指定要启动的 Shell 命令。'
    },
    terminal: {
